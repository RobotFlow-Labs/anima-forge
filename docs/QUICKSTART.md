...
```bash
curl -fsSL https://raw.githubusercontent.com/RobotFlow-Labs/anima-forge/refs/heads/main/install.sh \
...
```powershell
irm https://raw.githubusercontent.com/RobotFlow-Labs/anima-forge/refs/heads/main/install.ps1 | iex
```
